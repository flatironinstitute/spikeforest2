...
@hither.function('ironclust', '5.6.11-w1')
@hither.output_file('sorting_out')
@hither.container(default='docker://jamesjun/sf-ironclust:5.6.11')
...
def ironclust(recording_path, sorting_out, 
    ...
    adjacency_radius_out=100, merge_thresh=0.975, fft_thresh=8, knn=30, min_count=30, delta_cut=1,    
    pc_per_chan=0, batch_sec_drift=300, step_sec_drift=20,
    common_ref_type='trimmean', fGpu=True, clip_pre=.25, clip_post=.75
):
