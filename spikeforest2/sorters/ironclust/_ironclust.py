...
@hither.function('ironclust', '5.9.7-w2')
@hither.output_file('sorting_out')
@hither.container(default='docker://jamesjun/sf-ironclust:5.9.7')
...
def ironclust(recording_path, sorting_out, 
    ...
    merge_thresh_cc=1, nRepeat_merge=5, merge_overlap_thresh=.975
):
