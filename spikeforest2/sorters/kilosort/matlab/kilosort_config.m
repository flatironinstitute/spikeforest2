function ops = kilosort_config(params)
% params: nchan, sample_rate, dat_file, chanmap_file, Nfilt, freq_min, freq_max, Nt, kilo_thresh, use_car
...
ops.spkTh           = -params.kilo_thresh;     % spike threshold in standard deviations (4)
ops.loc_range       = [3  1];  % ranges to detect peaks; plus/minus in time and channel ([3 1])		
ops.long_range      = [30  6]; % ranges to detect isolated peaks ([30 6])		
ops.maskMaxChannels = 5;       % how many channels to mask up/down ([5])		
ops.crit            = .65;     % upper criterion for discarding spike repeates (0.65)		
ops.nFiltMax        = 10000;   % maximum "unique" spikes to consider (10000)
ops.CAR             = params.use_car;       % if 1 common reference is used
