...
./generate_unit_details.py output.json \
    ...
    --log-file gud.log.txt \
     --studysets SYNTH_MEAREC_TETRODE,SYNTH_MONOTRODE,MANUAL_FRANKLAB
#    --studysets PAIRED_BOYDEN,PAIRED_CRCNS_HC1,PAIRED_KAMPFF,PAIRED_MEA64C_YGER,PAIRED_MONOTRODE
